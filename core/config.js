...
const OS_CATALOG = {
  ...
  'Ubuntu 24.04.1 LTS (Noble Numbat)': {
    ...
    cloudImageUrl: 'https://cloud-images.ubuntu.com/noble/current/noble-server-cloudimg-amd64.vmdk',
    cloudImageSha256Url: 'https://cloud-images.ubuntu.com/noble/current/SHA256SUMS',
    cloudImageCodename: 'noble',
    cloudImageFilename: 'noble-server-cloudimg-amd64.vmdk',
    unattended: true,
    defaultUser: 'user',
  ...
  'Ubuntu 22.04.4 LTS (Jammy Jellyfish)': {
    ...
    cloudImageUrl: 'https://cloud-images.ubuntu.com/jammy/current/jammy-server-cloudimg-amd64.vmdk',
    cloudImageSha256Url: 'https://cloud-images.ubuntu.com/jammy/current/SHA256SUMS',
    cloudImageCodename: 'jammy',
    cloudImageFilename: 'jammy-server-cloudimg-amd64.vmdk',
    unattended: true,
    defaultUser: 'user', defaultPass: 'password',
    ram: 4096, cpus: 2, disk: 25600, vram: 128,
    graphicsController: 'vmsvga',
  ...
  'Ubuntu 20.04.6 LTS (Focal Fossa)': {
    ...
    cloudImageUrl: 'https://cloud-images.ubuntu.com/focal/current/focal-server-cloudimg-amd64.vmdk',
    cloudImageSha256Url: 'https://cloud-images.ubuntu.com/focal/current/SHA256SUMS',
    cloudImageCodename: 'focal',
    cloudImageFilename: 'focal-server-cloudimg-amd64.vmdk',
    unattended: true,
    defaultUser: 'user', defaultPass: 'password',
